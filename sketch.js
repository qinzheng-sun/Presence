...
function setup() {
    ...
    createCanvas(windowWidth, windowHeight);
    slider = createSlider(0, 255, 25);
    slider.position(590, 750);
...
function draw() {
  ...
  text("Use the colour sliders to express how you feel:", windowWidth/3, 520);
  textSize(20);
  ...
  moodValue  = slider.value();
   textSize(20);
  text("Your emotion size is:  " + moodValue, 590, 740);
...
function sendTheMessage() {
  ...
  if (nameInput.value() != "") { 
    ...
    window.location.href = "https://qinzheng-sun.github.io/Presence-co-presence/_pageTwo/index.html?you="+you+"&r="+redVal+"&g="+greenVal+"&b="+blueVal; 
